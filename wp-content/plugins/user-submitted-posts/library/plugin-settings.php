							...
							<div class="mm-table-wrap">
								<table class="widefat mm-table">
									...
									<tr>
										...
										<div class="mm-item-caption"><?php esc_html_e('By default, external CSS &amp; JavaScript files are loaded on every page. Here you may specify the URL of the USP form to load resources only on that page. Note: leave blank to load on all pages. Use commas to separate multiple URLs.', 'usp'); ?></div></td>
									</tr>
									<tr>
							...
							<div class="mm-table-wrap">
								<table class="widefat mm-table">
									...
									<tr>
										...
										<span class="mm-item-caption"><?php esc_html_e('Specify category ID(s) to use for &ldquo;Hidden/Default Category&rdquo;. Separate multiple IDs with a comma.', 'usp'); ?></span></td>
									</tr>
								</table>
							</div>
